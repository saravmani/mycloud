...
use db_name -- Switch to the database. If db doesn't exist then it will switch the context...and when we create the first document
                that time actual db will get created
